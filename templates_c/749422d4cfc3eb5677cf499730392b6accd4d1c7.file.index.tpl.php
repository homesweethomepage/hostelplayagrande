<?php /* Smarty version Smarty-3.1.14, created on 2016-12-19 21:44:41
         compiled from ".\templates\index.tpl" */ ?>
<?php /*%%SmartyHeaderCode:1327658582ad9c49d38-31318348%%*/if(!defined('SMARTY_DIR')) exit('no direct access allowed');
$_valid = $_smarty_tpl->decodeProperties(array (
  ...
  'nocache_hash' => '1327658582ad9c49d38-31318348',
  'function' => 
  array (
  ),
  'version' => 'Smarty-3.1.14',
  'unifunc' => 'content_58582ad9c9d256_32787599',
  'variables' => 
  array (
    'galeria' => 0,
    'itemGaleria' => 0,
...
<?php if ($_valid && !is_callable('content_58582ad9c9d256_32787599')) {function content_58582ad9c9d256_32787599($_smarty_tpl) {?><!DOCTYPE html>
<html lang="es">
<head>
  <meta charset="utf-8">
    ...
    <section id="galery2" class="section-border-top">
      ...
      <div class="container">
        ...
        <div class="row centerimg">
          <?php  $_smarty_tpl->tpl_vars['itemGaleria'] = new Smarty_Variable; $_smarty_tpl->tpl_vars['itemGaleria']->_loop = false;
 $_from = $_smarty_tpl->tpl_vars['galeria']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
foreach ($_from as $_smarty_tpl->tpl_vars['itemGaleria']->key => $_smarty_tpl->tpl_vars['itemGaleria']->value){
$_smarty_tpl->tpl_vars['itemGaleria']->_loop = true;
?>
          <div class="foto-galery col-md-4 col-sm-6">
            <div class="box-img box-shadow">
              <img src="<?php echo $_smarty_tpl->tpl_vars['itemGaleria']->value['ruta'];?>
" alt="foto de <?php echo $_smarty_tpl->tpl_vars['itemGaleria']->value['hostel'];?>
">
            </div>
          </div>
          <?php } ?>
...
?>
        <div class="col-md-4 col-sm-6 custom-padding">
          <div class="box-actividades box-shadow">
            <div class="box-top">
              <img src="uploaded/imagenes/actividades/<?php echo $_smarty_tpl->tpl_vars['actividad']->value['ruta'];?>
" alt="paracaidismo">
            </div>
            <div class="box-bot">
              <span><?php echo $_smarty_tpl->tpl_vars['actividad']->value['activity'];?>
</span>
              <div class="texto">
                <?php echo $_smarty_tpl->tpl_vars['actividad']->value['cuerpo'];?>
 ...
 $_from = $_smarty_tpl->tpl_vars['tarifas']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
...
?>
          <?php if ($_smarty_tpl->tpl_vars['i']->index==0){?>
            <li data-target="#carousel-tarifas" data-slide-to="<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
" class="active"></li>
          <?php }else{ ?>
            <li data-target="#carousel-tarifas" data-slide-to="<?php echo $_smarty_tpl->tpl_vars['i']->value;?>
"></li>
 ...
 $_from = $_smarty_tpl->tpl_vars['tarifas']->value; if (!is_array($_from) && !is_object($_from)) { settype($_from, 'array');}
 $_smarty_tpl->tpl_vars['tarifa']->index=-1;
foreach ($_from as $_smarty_tpl->tpl_vars['tarifa']->key => $_smarty_tpl->tpl_vars['tarifa']->value){
$_smarty_tpl->tpl_vars['tarifa']->_loop = true;
 $_smarty_tpl->tpl_vars['tarifa']->index++;
?>
        <?php if ($_smarty_tpl->tpl_vars['tarifa']->index==0){?>
          <div class="item active">
        <?php }else{ ?>
          <div class="item">
        <?php }?>
          <img class="tarifa" src="uploaded/imagenes/tarifas/<?php echo $_smarty_tpl->tpl_vars['tarifa']->value['ruta'];?>
" alt="<?php echo $_smarty_tpl->tpl_vars['tarifa']->value['actividad'];?>
">
        </div>
        <?php } ?>
      </div><!-- ./SLIDES -->
  ...
  <!-- NOVEDADES -->
    <section id="news" class="section-border-top">
      <div class="container">
        ...
        <article>
          <div>
            <h3><?php echo $_smarty_tpl->tpl_vars['novedades']->value[0]['novedad'];?>
</h3>
            <span><i class="fa fa-calendar" aria-hidden="true"></i>28/11/2016</span>
          </div>
          <div class="row">
            <div class="col-md-7 box-text-news">
              <?php echo $_smarty_tpl->tpl_vars['novedades']->value[0]['cuerpo'];?>
            ...
            <div class="col-md-5">
              <div class="box-img box-shadow">
                <img class="img-responsive" src="<?php echo $_smarty_tpl->tpl_vars['novedades']->value[0]['imagen'];?>
" alt="Foto Noticia 1">
              </div>
            </div>
          </div>
