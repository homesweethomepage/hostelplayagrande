...
<html>
  <head>
    <meta charset="utf-8">
    <title>Hostel Playa Grande - Actividades</title>
  ...
  <body>
      ...
      <div id="page-wrapper">
        ...
        <div class="row">
          <div class="col-md-6 well">
            ...
            <h3>Agregar Actividad
              <a href="http://localhost/proyectos/hostel/index.php?action=admin_actividades" class="btn btn-default btn-xs pull-right " aria-label="Refresh">
                <span class="glyphicon glyphicon-refresh" aria-hidden="true"></span>
              </a>
            </h3>

            <form id="submitActivity" action="index.php?action=agregar_activity" method="POST" enctype="multipart/form-data">
              <div class="form-group">
                <label for="activity">Nombre</label>
                <input type="text" class="form-control" id="activity" name="activity" placeholder="Nombre" required>
              </div>
              ...
              <div class="form-group">
                <label for="activityToUpload">Imágen</label>
                <input type="file" name="activityToUpload[]" id="activityToUpload" required/>
              </div>

              <button id="js-button-activities" type="submit" class="btn btn-default">Agregar</button>
            </form>

          </div>
        </div>

        <div id="listaActivities" class="row text-center">
        </div>
    ...
    <script src="js/hostelABMY.js"></script>
